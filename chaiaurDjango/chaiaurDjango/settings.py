...
ALLOWED_HOSTS = ['*']  # For production, restrict with your domain or Render URL
...
NPM_BIN_PATH = "C:\\Program Files\\nodejs\\npm.cmd"  # Adjust if needed for Linux/Mac

MIDDLEWARE = [
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Must be FIRST for static serving
